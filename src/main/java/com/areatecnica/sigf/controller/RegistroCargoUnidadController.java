 ...
 * @author ianfr
 */
@Named(value = "registroCargoUnidadController")
@ViewScoped
public class RegistroCargoUnidadController implements Serializable {
     ...
     */
    public RegistroCargoUnidadController() {
        this.fecha = new Date();
    ...
    public void loadUnidad() {
        ...
        try {
            ...
            JsfUtil.addErrorMessage("Error al validar la fecha");
        }
        ...
        if (this.selected.getCargoBusIdTipo() != null) {
            ...
            if (this.unidadNegocio != null) {
                ...
                this.busDaoImpl = new IBusDaoImpl();
                this.busItems = this.busDaoImpl.findByUnidad(this.unidadNegocio);

                registroCargoItems = new ArrayList<>();

                System.err.println("cargo bus:" + this.selected.getCargoBusIdTipo().getTipoCargoNombre());
                System.err.println("fecha inicio:" + this.selected.getCargoBusFechaInicio());
                System.err.println("fecha final:" + this.currentDate.getMaxDate());
