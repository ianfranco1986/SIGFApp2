 ...
 * @author ianfr
 */
@Named(value = "registroAbonoFlotaController")
@ViewScoped
public class RegistroAbonoFlotaController implements Serializable {
     ...
     */
    public RegistroAbonoFlotaController() {
        this.fecha = new Date();
        ...
        try {
            ...
            Logger.getLogger(RegistroAbonoFlotaController.class.getName()).log(Level.SEVERE, null, ex);
        }
