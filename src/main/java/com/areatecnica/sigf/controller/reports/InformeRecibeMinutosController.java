 ...
 */
@Named(value = "informeRecibeMinutosController")
@ViewScoped
public class InformeRecibeMinutosController implements Serializable {
     ...
     */
    public InformeRecibeMinutosController() {
        ...
        try {
            ...
            Logger.getLogger(InformeRecibeMinutosController.class.getName()).log(Level.SEVERE, null, ex);
        }
