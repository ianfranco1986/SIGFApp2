 ...
 */
@Named(value = "informeConsumoCombustibleoController")
@ViewScoped
public class InformeConsumoCombustibleController implements Serializable {
     ...
     */
    public InformeConsumoCombustibleController() {
