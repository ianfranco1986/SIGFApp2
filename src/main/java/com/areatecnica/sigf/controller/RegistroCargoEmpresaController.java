 ...
 * @author ianfr
 */
@Named(value = "registroCargoEmpresaController")
@ViewScoped
public class RegistroCargoEmpresaController implements Serializable {
     ...
     */
    public RegistroCargoEmpresaController() {
        this.fecha = new Date();
        ...
        try {
            ...
            Logger.getLogger(RegistroCargoEmpresaController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void handleEmpresa() {
        ...
        if (this.selected.getCargoBusIdTipo() != null) {
            ...
            if (flag) {
                JsfUtil.addSuccessMessage("Existen cargos del tipo: " + this.selected.getCargoBusIdTipo().getTipoCargoNombre() + " ingresados a la empresa:" + this.empresa.getEmpresaNombre() + ". Los cambios que realice afectarán a todos los cargos registrados");
            }
        } else {
        ...
        if (this.empresa != null) {
            ...
            for (Bus b : this.busItems) {
                ...
                if (!this.items.isEmpty()) {
                    ...
                    RegistroCargoEmpresa c = new RegistroCargoEmpresa(b, cargo);
                    c.setKey(i);
                    registroCargoItems.add(c);*/
                }
