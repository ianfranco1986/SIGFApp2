 ...
 * @author ianfr
 */
@Named(value = "registroAbonoUnidadController")
@ViewScoped
public class RegistroAbonoUnidadController implements Serializable {
     ...
     */
    public RegistroAbonoUnidadController() {
        this.fecha = new Date();
        ...
        try {
            ...
            Logger.getLogger(RegistroAbonoUnidadController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void handleFlota() {
        ...
        if (this.selected.getAbonoBusIdTipoAbono() != null) {
            ...
            if (flag) {
                JsfUtil.addSuccessMessage("Existen abonos del tipo: " + this.selected.getAbonoBusIdTipoAbono().getTipoAbonoNombre() + " ingresados a la flota:" + this.flota.getFlotaNombre() + ". Los cambios que realice afectarán a todos los abonos registrados");
            }
        } else {
        ...
        if (this.flota != null) {
            ...
            for (Bus b : this.busItems) {
                ...
                if (!this.items.isEmpty()) {
                    ...
                    RegistroAbonoFlota c = new RegistroAbonoFlota(b, abono);
                    c.setKey(i);
                    registroAbonoItems.add(c);*/
                }
