 ...
 * @author ianfr
 */
@Named(value = "reportControllerPetroleoCajaFecha")
@ViewScoped
public class ReportControllerPetroleoCajaFecha implements Serializable {
     ...
     */
    public ReportControllerPetroleoCajaFecha() {
