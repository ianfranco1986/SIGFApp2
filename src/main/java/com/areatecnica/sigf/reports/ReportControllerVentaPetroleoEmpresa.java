 ...
 * @author ianfr
 */
@Named(value = "reportControllerVentaPetroleoEmpresa")
@ViewScoped
public class ReportControllerVentaPetroleoEmpresa implements Serializable {
    ...
    private Date desde;
    private Date hasta;
    private String informe = "inf-detalle_ingresos_bus";
     ...
     */
    public ReportControllerVentaPetroleoEmpresa() {
