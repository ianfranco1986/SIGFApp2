 ...
 * @author ianfr
 */
@Named(value = "reportControllerPetroleoBusMesResumen")
@ViewScoped
public class ReportControllerPetroleoBusMesResumen implements Serializable {
    ...
    private String informe = "inf-venta_petroleo_bus_resumen";

    /**
     * Creates a new instance of ReportControllerBusMes
     */
    public ReportControllerPetroleoBusMesResumen() {
    }
