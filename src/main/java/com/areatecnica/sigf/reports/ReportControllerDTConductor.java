 ...
 * @author ianfr
 */
@Named(value = "reportControllerDTConductor")
@ViewScoped
public class ReportControllerDTConductor implements Serializable {

    private Date fecha;
    private Date desde;
    private Date hasta;
    private String informe = "inf-dt_conductor";
    private int mes;
    private int anio;
    private String list;
     ...
     */
    public ReportControllerDTConductor() {
    ...
    public Map<String, Object> getMap() {
        ...
        map.put("fecha", getFechaCompleta());
        map.put("from", desde);
        map.put("hasta", hasta);
        map.put("list", array);
