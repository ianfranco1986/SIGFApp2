 ...
 * @author ianfr
 */
@Named(value = "reportControllerMinutoFechaNuevo")
@ViewScoped
public class ReportControllerMinutoFechaNuevo implements Serializable {
    ...
    private String informe = "inf-registro_minutos_fecha_nuevo";

    /**
     * Creates a new instance of ReportControllerBusMes
     */
    public ReportControllerMinutoFechaNuevo() {
    }
