 ...
 * @author ianfr
 */
@Named(value = "reportControllerDetalleCobroMinutosBus")
@ViewScoped
public class ReportControllerDetalleCobroMinutosBus implements Serializable {
    ...
    private Date desde;
    private Date hasta;
    private String informe = "inf-detalle_cobro_minutos_bus";
     ...
     */
    public ReportControllerDetalleCobroMinutosBus() {
