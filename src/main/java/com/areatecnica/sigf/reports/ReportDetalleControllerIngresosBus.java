 ...
 * @author ianfr
 */
@Named(value = "reportDetalleControllerIngresosBus")
@ViewScoped
public class ReportDetalleControllerIngresosBus implements Serializable {
     ...
     */
    public ReportDetalleControllerIngresosBus() {
