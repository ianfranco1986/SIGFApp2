 ...
 * @author ianfr
 */
@Named(value = "reportControllerDetalleMinutosBus")
@ViewScoped
public class ReportControllerDetalleMinutosBus implements Serializable {
    ...
    private Date desde;
    private Date hasta;
    private String informe = "inf-detalle_minutos_bus";
     ...
     */
    public ReportControllerDetalleMinutosBus() {
