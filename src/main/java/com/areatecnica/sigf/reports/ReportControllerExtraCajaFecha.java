 ...
 * @author ianfr
 */
@Named(value = "reportControllerExtraCajaFecha")
@ViewScoped
public class ReportControllerExtraCajaFecha implements Serializable {
     ...
     */
    public ReportControllerExtraCajaFecha() {
    ...
    private void init() {
        ...
        this.fecha = new Date();
        this.informe = "inf-recaudacion_extra_caja_fecha";
    }
