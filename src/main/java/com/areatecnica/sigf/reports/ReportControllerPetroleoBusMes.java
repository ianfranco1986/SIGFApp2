 ...
 * @author ianfr
 */
@Named(value = "reportControllerPetroleoBusMes")
@ViewScoped
public class ReportControllerPetroleoBusMes implements Serializable {
    ...
    private String informe = "inf-venta_petroleo_bus";

    /**
     * Creates a new instance of ReportControllerBusMes
     */
    public ReportControllerPetroleoBusMes() {
    }
