...
import com.areatecnica.sigf.facade.CuentaBancariaFacade;
...
public class CuentaBancariaConverter implements Converter {
    ...
    private CuentaBancariaFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(CuentaBancariaFacade.class).get();
