...
import com.areatecnica.sigf.facade.NumeralSurtidorFacade;
...
public class NumeralSurtidorConverter implements Converter {
    ...
    private NumeralSurtidorFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(NumeralSurtidorFacade.class).get();
