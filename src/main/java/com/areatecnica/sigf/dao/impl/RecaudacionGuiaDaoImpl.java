 ...
 * @author ianfr
 */
public class RecaudacionGuiaDaoImpl extends GenericDAOImpl<RecaudacionGuia> implements IRecaudacionGuiaDao<RecaudacionGuia> {

    public RecaudacionGuiaDaoImpl() {
    ...
    public int findByEgreso(Empresa empresa, Date from, Date to, int egreso) {
        try {
