 ...
 * @author ianfr
 */
public class LoginAdministradorDaoImpl extends GenericDAOImpl<Administrador> implements ILoginAdministradorDao<Administrador>{

    private static final long serialVersionUID = 1602695723923335094L;

    public LoginAdministradorDaoImpl() {
