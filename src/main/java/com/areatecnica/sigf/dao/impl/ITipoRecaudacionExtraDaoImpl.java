 ...
 * @author ianfr
 */
public class ITipoRecaudacionExtraDaoImpl extends GenericDAOImpl<TipoRecaudacionExtra> implements ITipoRecaudacionExtraDao<TipoRecaudacionExtra> {

    public ITipoRecaudacionExtraDaoImpl() {
