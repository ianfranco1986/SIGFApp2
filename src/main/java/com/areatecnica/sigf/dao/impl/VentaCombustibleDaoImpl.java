 ...
 * @author ianfr
 */
public class VentaCombustibleDaoImpl extends GenericDAOImpl<VentaCombustible> implements IVentaCombustibleDao<VentaCombustible> {

    public VentaCombustibleDaoImpl() {
