...
@NamedQueries({
    ...
    @NamedQuery(name = "CargoLiquidacion.findByTipoCargoBetweenDates", query = "SELECT c FROM CargoLiquidacion c WHERE c.cargoLiquidacionCargoId = :cargoLiquidacionCargoId AND c.cargoLiquidacionLiquidacionEmpresaId.liquidacionEmpresaFechaLiquidacion BETWEEN :from AND :to ORDER BY c.cargoLiquidacionCargoId.tipoCargoNombre ASC"),
