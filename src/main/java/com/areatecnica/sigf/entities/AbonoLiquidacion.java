...
@NamedQueries({
    ...
    @NamedQuery(name = "AbonoLiquidacion.findByTipoAbonoBetweenDates", query = "SELECT a FROM AbonoLiquidacion a WHERE a.abonoLiquidacionTipoId =:abonoLiquidacionTipoId AND a.abonoLiquidacionLiquidacionEmpresaId.liquidacionEmpresaFechaLiquidacion BETWEEN :from AND :to ORDER BY a.abonoLiquidacionTipoId.tipoAbonoNombre ASC"),
