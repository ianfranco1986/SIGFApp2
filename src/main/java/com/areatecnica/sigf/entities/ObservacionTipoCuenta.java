...
public class ObservacionTipoCuenta extends BaseEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return (this.observacionTipoCuentaId != null || other.observacionTipoCuentaId == null) && (this.observacionTipoCuentaId == null || this.observacionTipoCuentaId.equals(other.observacionTipoCuentaId));
    }
