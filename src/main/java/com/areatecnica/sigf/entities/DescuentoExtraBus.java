...
public class DescuentoExtraBus extends BaseEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return (this.descuentoExtraBusId != null || other.descuentoExtraBusId == null) && (this.descuentoExtraBusId == null || this.descuentoExtraBusId.equals(other.descuentoExtraBusId));
    }
