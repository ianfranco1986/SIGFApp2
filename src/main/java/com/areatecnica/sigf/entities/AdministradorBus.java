 ...
 */
@Entity
@Table(name = "administrador_bus", catalog = "sigfdb_baquedano", schema = "")
@XmlRootElement
@NamedQueries({
...
public class AdministradorBus implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.administradorBusId == null && other.administradorBusId != null) || (this.administradorBusId != null && !this.administradorBusId.equals(other.administradorBusId))) {
            return false;
        }
        return true;
    }
