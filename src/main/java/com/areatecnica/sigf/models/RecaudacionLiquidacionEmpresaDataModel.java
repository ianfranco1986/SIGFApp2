 ...
 * @author ianfr
 */
public class RecaudacionLiquidacionEmpresaDataModel extends ListDataModel<RegistroLiquidacionBusController.RecaudacionGuiaHelper> implements SelectableDataModel<RegistroLiquidacionBusController.RecaudacionGuiaHelper> {

    public RecaudacionLiquidacionEmpresaDataModel() {
    }

    public RecaudacionLiquidacionEmpresaDataModel(List<RegistroLiquidacionBusController.RecaudacionGuiaHelper> list) {
        super(list);
    }
