 ...
 * @author ianfr
 */
public class GuiaBoletoDataModel extends ListDataModel<Guia> implements SelectableDataModel<Guia> {

    public GuiaBoletoDataModel() {
    }

    public GuiaBoletoDataModel(List<Guia> list) {
        super(list);
    }
